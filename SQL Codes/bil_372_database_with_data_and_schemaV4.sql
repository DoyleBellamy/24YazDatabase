...
CREATE TABLE `uygundur` (
  ...
  KEY `VeterinerID` (`VeterinerID`),
  CONSTRAINT `uygundur_ibfk_1` FOREIGN KEY (`SaatID`) REFERENCES `saatler` (`SaatID`),
  CONSTRAINT `uygundur_ibfk_2` FOREIGN KEY (`VeterinerID`) REFERENCES `veteriner` (`KullanıcıID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-07-21 23:48:09
